            ...
            <form action="{{ url(config('adminlte.register_url', 'register')) }}" method="post">
                ...
                <div class="form-group has-feedback {{ $errors->has('city') ? 'has-error' : '' }}">
                    <input type="text" name="city" class="form-control" value="{{ old('city') }}"
                           placeholder="{{ trans('adminlte::adminlte.city') }}">
                ...
                <div class="form-group has-feedback {{ $errors->has('number') ? 'has-error' : '' }}">
                    <input type="text" name="number" class="form-control" value="{{ old('number') }}"
                           placeholder="{{ trans('adminlte::adminlte.number') }}">
                    <span class="glyphicon glyphicon-home form-control-feedback"></span>
                ...
                <div class="form-group has-feedback {{ $errors->has('apartment_number') ? 'has-error' : '' }}">
                    <input type="text" name="number" class="form-control" value="{{ old('apartment_number') }}"
                           placeholder="{{ trans('adminlte::adminlte.apartment_number') }}">
                    <span class="glyphicon glyphicon-home form-control-feedback"></span>
