...
@section('body')
    <div class="wrapper">
        ...
        <header class="main-header">
            ...
            @role('user')
              <a href="{{ route('indexUser') }}" class="logo">
            @endrole
                          ...
                          <ul class="dropdown-menu">
                            ...
                            <li class="user-header">
                              ...
                              <p>
                                ...
                                <small>od {{ \Carbon\Carbon::parse(Auth::user()->created_at)->format('Y-m') }}</small>
                              </p>
                            </li>
                            <!-- Menu Footer-->
        ...
        <footer class="main-footer">
          ...
          <strong>Copyright © {{date('Y')}} <a href="http://szynal.com.pl">szynal.com.pl/pizzeria</a></strong> All rights
          reserved.
        </footer>
